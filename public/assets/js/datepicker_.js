...
function Datepicker(isHijr,year,month,firstDay,lang,theme,width){
	...
	createPicker=function(){
		let closeBtnElm=createElm('button','w3-button w3-ripple w3-display-topright','<svg width="18" height="19"><path d="M5 9L5 10L8 13L5 16L5 17L6 17L9 14L12 17L13 17L13 16L10 13L13 10L13 9L12 9L9 12L6 9Z"/></svg>'),
			prevYearBtnElm=createElm('button','w3-button w3-ripple w3-display-left down1','<svg width="40" height="20"><path d="M6 7L3 13L6 19L8 19L5 13L8 7Z M13 7L10 13L13 19L15 19L12 13L15 7Z"/><text transform="translate(18.436 16)" ><tspan x="-2" y="0.5">-1</tspan></text></svg>'),
			prevYearBtnElm10=createElm('button','w3-button w3-ripple w3-display-left down10','<svg width="40" height="20"><path d="M6 7L3 13L6 19L8 19L5 13L8 7Z M13 7L10 13L13 19L15 19L12 13L15 7Z"/><text transform="translate(18.436 16)" ><tspan x="-2" y="0.5">-10</tspan></text></svg>'),
			nextYearBtnElm=createElm('button','w3-button w3-ripple w3-display-right up1','<svg width="40" height="20"><path d="M4 7L7 13L4 19L6 19L9 13L6 7Z M11 7L14 13L11 19L13 19L16 13L13 7Z" transform="translate(21 0)" /><text transform="translate(18.436 16)" ><tspan x="-12" y="0.5">+1</tspan></text></svg>'),
			nextYearBtnElm10=createElm('button','w3-button w3-ripple w3-display-right up10','<svg width="40" height="20"><path d="M4 7L7 13L4 19L6 19L9 13L6 7Z M11 7L14 13L11 19L13 19L16 13L13 7Z" transform="translate(21 0)" /><text transform="translate(18.436 16)" ><tspan x="-17" y="0.5">+10</tspan></text></svg>'),
		...
		headerElm.appendChild(prevYearBtnElm10);
		headerElm.appendChild(nextYearBtnElm);
		headerElm.appendChild(nextYearBtnElm10);
		...
		addEvt(prevYearBtnElm10,'click',onDecYear10);
		addEvt(nextYearBtnElm,'click',onIncYear);
		addEvt(nextYearBtnElm10,'click',onIncYear10);
	...
	updHeader=function(){
		...
		//yearValElm.innerHTML= '<input type="number" id="mySelect"  vlue="'+Datepicker.getDigit(dispDate.getYearString())+'" />';
	...
	onDecYear10=function(){gridAni='right';return isRTL?incYear():decYear10()},
	onIncYear=function(){gridAni='left';return isRTL?decYear():incYear()},
	onIncYear10=function(){gridAni='left';return isRTL?decYear():incYear10()},
	...
	decYear10=function(){dispDate.setFullYear(dispDate.getFullYear()-10);updPicker()},
	incYear=function(){dispDate.setFullYear(dispDate.getFullYear()+1);updPicker()},
	incYear10=function(){dispDate.setFullYear(dispDate.getFullYear()+10);updPicker()},
...
/* Lang */	if(typeof lang=='string'){lang=lang.toLowerCase();if(typeof Datepicker.language[lang]!='object')lang='en'}
	else lang='ar';
...
Date.prototype.getDateString=function(){
	let mgday = Datepicker.getDigit(this.getDate()).length;
	if (mgday != 1) {

	return Datepicker.getDigit(this.getYearString()+'/'+this.getMonthNamesNum()+'/'+this.getDate())
 } 
  else {
	return Datepicker.getDigit(this.getYearString()+'/'+this.getMonthNamesNum()+'/'+'0'+this.getDate())
 }
...
Date.prototype.getMonthNamesNum=function(m){
	m=(HijriDate.int(m,this.getMonth())%12+12)%12;
	return Datepicker.getVal('monthNamesNum')[m]
};
...
HijriDate.prototype.getDateString=function(){
	let mgday = Datepicker.getDigit(this.getDate()).length;
	if (mgday != 1) {
	return Datepicker.getDigit(this.getYearString()+'/'+this.getMonthNameNum()+'/'+this.getDate())
}
	else {
		return Datepicker.getDigit(this.getYearString()+'/'+this.getMonthNameNum()+'/'+'0'+this.getDate())
	}
};
...
HijriDate.prototype.getMonthNameNum=function(m){
	m=(HijriDate.int(m,this.getMonth())%12+12)%12;
	let p=Datepicker;
	return p.lang=='en'?HijriDate.monthNames[m]:p.getVal('monthNamesNum')[m]
};
...
Object.defineProperty(Datepicker,'themes',{value:['darkgreen']});
...
Datepicker.language={en:{
	...
	monthNamesNum:["01","02","03","04","05","06","07","08","09","10","11","12"],
...
Datepicker.language['ar']={
	...
	hMonthNames:["مُحَرَّم","صَفَر ","رَبيع الاوَّل","رَبيع الآخِر","جُمادى الأولى","جُمادى الآخِر","رَجَب","شَعبان","رَمَضان","شَوّال","ذو القَعدة","ذو الحِجّة"]
};
