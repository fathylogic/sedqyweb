...
Date.prototype.getDateString=function(){
	...
	//return Datepicker.getDigit(this.getDate()+'-'+this.getMonth()+'-'+this.getFullYear())
...
HijriDate.prototype.getDateString=function(){
	return Datepicker.getDigit(this.getWeekdayName()+', '+this.getDate()+' '+this.getMonthName()+' '+this.getYearString())
	//return Datepicker.getDigit(this.getDate() )
};
...
Object.defineProperty(Datepicker,'themes',{value:['dark-grey']});
...
picker.onPicked=function(){
	...
	if(picker.getPickedDate() instanceof Date){
		...
		console.log(document.getElementById('gregDate').value);
		console.log(document.getElementById('hijrDate').value);
	}else{
