                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <img src="<?= asset('storage/' . $center->img) ?>" width="400px"
                                                    height="400px">
                                            </div>
                            ...
                            <td>
                                ...
                                <div class="d-inline-block">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end m-0">
                                        <li><a href="{{ route('centers.edit', $center->id) }}"" class="dropdown-item"><i
                                                    class="fa-solid fa-circle-info"></i> تعديل</a></li>

                                        <div class="dropdown-divider"></div>
                                        <li><a href="#" onclick="fn_delete_center({{ $center->id }})"
                                                class="dropdown-item text-danger delete-record"><i
                                                    class="fa-solid fa-trash-can"></i> حذف</a></li>
                                    </ul>
                                </div>
                                <a href="{{ route('centers.show', $center->id) }}" class="btn btn-sm btn-icon item-edit">
